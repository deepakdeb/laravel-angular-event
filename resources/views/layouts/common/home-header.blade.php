    ...
    <nav class="navbar navbar-expand-lg classic transparent position-absolute navbar-dark">
        <div class="container flex-lg-row flex-nowrap align-items-center">
            <div class="navbar-brand w-100">
                <a href="{{ url('/') }}">
                    <img style="max-width: 90px; height: auto;" class="logo-dark"
                        src="{{ url('/assets/images/logo.png') }}" srcset="{{ url('/assets/images/logo.png') }} 2x"
                        alt="" />
                    <img style="max-width: 90px; height: auto;" class="logo-light"
                        src="{{ url('/assets/images/logo.png') }}" srcset="{{ url('/assets/images/logo.png') }} 2x"
                        alt="" />
                </a>
            </div>
            <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                ...
                <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                    <ul class="navbar-nav">
                        ...
                        @endif
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="{{ route('gallery') }}">Events Gallery</a>
                        </li> --}}
                        @guest
                                    ...
                                    <li class="mega-menu-content mega-menu-scroll">
                                        <ul class="row row-cols-1 list-unstyled">
                                            ...
                                            @if (Auth::user() && Auth::user()->hasRole('member'))
                                                <li class="col">
                                                    <a class="dropdown-item"
                                                        href="{{ route('profile.registrations') }}">Event
                                                        Registrations</a>
                                                </li>
                                                <li class="col">
                                                    <a class="dropdown-item"
